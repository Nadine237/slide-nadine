...
othersprite = sprites.create(img("""
    ...
    """),
    SpriteKind.player)
othersprite.set_position(51, 102)
controller.move_sprite(othersprite, 100, 0)
othersprite.set_stay_in_screen(True)
info.set_score(0)
...
def on_update_interval():
    ...
    projectile2 = sprites.create_projectile_from_side(img("""
        ...
        0,
        50)
    projectile2.set_position(randint(10, 160), 0)
    projectile2.set_velocity(0, 40)
    if info.score() > 15:
        game.set_game_over_message(True, "GOOD JOB")
